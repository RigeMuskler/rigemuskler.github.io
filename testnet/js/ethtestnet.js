...
//for the current profile holder - takes smart contract as args
async function getProfile(_smartContract){
	...
	$('#statusAmount').text('Amount: '+(holder[2]/(10**18))+' ETH');
...
async function getClubInfo(_smartContract){
	...
	$('#stakeAmount').text(info[1]/(10**18) + " ETH");
	//secs to days
...
async function getAccountInfo(_smartContract){
	...
	$('#pendingRefund').text(accountInfo[1]/(10**18) + " ETH");
	//secs to days
...
$(function(){
    ...
    jQuery(document).ready(function() {
    	...
    	//slideshow
		$('body').backstretch([
	 		 "images/eth/tm-bg-slide-1.jpg", 
	 		 "images/eth/tm-bg-slide-2.jpg",
			 "images/eth/tm-bg-slide-3.jpg",
			 "images/eth/tm-bg-slide-4.jpg",
			 "images/eth/tm-bg-slide-5.jpg"
		...
		$('#connectWalletButton').click( async function(){
			...
			if (hasMetaMask){
				...
				var ethContractAddress = "0x6ba18cebb83efa3baff9445bc16bfbc0a0b8e543";
				smartContract = new web3.eth.Contract(smartContractABI);
				smartContract.options.address = ethContractAddress;
				...
				$('#alertDiv').html('<div class="alert alert-danger" role="alert"><p style="text-align:center">No Ethereum compactible browser! Kindly Consider installing MetaMask  &nbsp <span> <a href="#" data-dismiss="alert" class="badge badge-info"> Close</a></span></p></div>');
			}
